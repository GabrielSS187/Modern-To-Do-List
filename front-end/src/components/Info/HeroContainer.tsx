...
export function HeroContainer () {
  return (
    <div>
      ...
      <AnimationContainer direction="right" className="absolute top-36 right-6 w-60 h-72 min-[900px]:h-96 min-[900px]:w-72 min-[900px]:right-20 min-[900px]:top-24 xl:h-[29rem] xl:w-[25rem] xl:top-32">
        <img 
