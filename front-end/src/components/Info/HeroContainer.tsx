...
export function HeroContainer () {
  return (
    <div className="">
      <img src={infoFolder.heroArrowImg} alt="arrow image" className="z-10 absolute -top-14 -right-20 sm:w-96 sm:top-14 md:w-[25rem] min-[900px]:w-[32rem] min-[900px]:-top-3 xl:w-[40rem]"/>
      <img 
