...
export function Todo ({todo, index, onKeyDown, selectedIndex, moveCard}: IProps) {
  ...
  return (
    ...
    >
      <button role="button" className="text-primary-green" aria-label="uncheck todo" title="uncheck todo">
        <CheckCircle size={27} />
      </button>
